...
export default function App() {
  ...
  // Navigation logic to cycle through your 21 images
  ...
  return (
    <div style={{ backgroundColor: '#000', minHeight: '100vh', margin: 0, padding: 0, color: '#fff', fontFamily: 'sans-serif', fontStyle: 'italic', fontWeight: 900 }}>
      ...
      {/* 1. TOP NAVIGATION OVERLAY (Purple & Black Studio Style) */}
      <div style={{ position: 'fixed', top: 0, width: '100%', display: 'flex', justifyContent: 'center', gap: '40px', padding: '15px', background: 'rgba(5,5,5,0.9)', zIndex: 1000, borderBottom: '3px solid #8a2be2' }}>
      ...
      {/* 2. APP CONTENT (Your Images Only) */}
      <div style={{ position: 'relative', width: '100%', paddingTop: '80px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        
        {/* VIDEO BACKGROUND (PLAYS ONLY ON PAGE 1 BEHIND YOUR IMAGE) */}
        {page === 1 && (
          <video autoPlay loop muted playsInline style={{ position: 'absolute', top: '80px', width: '100%', height: 'auto', zIndex: 0 }}>
        ...
        {/* PAGE 13: THE INTERACTIVE SLIDER OVERLAY */}
        {page === 13 && (
      ...
      {/* 3. STUDIO FOOTER */}
      <div style={{ background: '#050505', padding: '30px', textAlign: 'center', borderTop: '3px solid #8a2be2', marginTop: 'auto' }}>
