...
const CSS = `
  ...
  .black-btn { background: #000; color: #fff; border: 2px solid #8a2be2; padding: 15px 35px; border-radius: 10px; font-size: 1.2rem; cursor: pointer; font-weight: bold; transition: 0.3s; }
              ...
              <div style={{maxWidth: '900px', margin: '0 auto', border: '3px solid #8a2be2', background:'#000'}}>
                ...
                {page === 13 && (
                  <div style={{padding: '40px', background: '#000'}}>
                    ...
                    <input type="range" min="0" max="180" value={mins} style={{width: '80%', cursor:'pointer'}} onChange={(e) => setMins(Number(e.target.value))} />
                  </div>
                )}
              </div>
            )}
