...
const CSS = `
  ...
  /* DESIGN LOCK: PURPLE & BLACK THEME */
  ...
  .p-card { border: 2px solid #333; padding: 25px; background: #0a0a0a; width: 220px; text-align: center; border-radius: 10px; }
      ...
      {view === 'app' && (
        <>
          ...
          <div style={{ padding: '40px', textAlign: 'center' }}>
            {/* PAGE 3: PRICING UPDATED TO 20-30-50 */}
            {page === 3 && (
